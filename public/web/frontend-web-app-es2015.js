...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'user',
                loadChildren: () => __webpack_require__.e(/*! import() | frontend-web-user */ "frontend-web-user").then(__webpack_require__.bind(null, /*! @frontend/web/user */ "../../libs/web/user/src/index.ts")).then(m => m.WebUserModule),
                canLoad: [_frontend_common_shared__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
            }
        ]
    }
